...
run_dir="_runs/phase1_lowstate_highstate_lowcmd_boundary_20260914/$run_id"
...
export TROT_PHASE1_BOUNDARY_TRACE=1
export TROT_PHASE1_BOUNDARY_TRACE_BASE="$run_abs/boundary"
export TROT_PHASE1_BOUNDARY_TRACE_START_TICK=11800
export TROT_PHASE1_BOUNDARY_TRACE_END_TICK=12600
