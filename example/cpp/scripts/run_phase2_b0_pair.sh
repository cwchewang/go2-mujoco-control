...
# use identical non-terrain arguments and a common flat scene. The canonical
# DDS runtime layer in run_trot.sh owns the per-domain lock, diagnostics, and
# fail-safe stale-state cleanup; both runs remain sequential.
