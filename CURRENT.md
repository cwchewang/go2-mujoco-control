...
Branch: `infra/governance-diagnosis-20260922`.
Task: [Governance repair and offline diagnosis](docs/research/TASK_GOVERNANCE_DIAGNOSIS_20260922.md).
Closeout: [Governance repair and offline diagnosis results](docs/validation/governance_diagnosis_20260922/RESULTS.md).
Stage: offline governance repair and first-trace diagnosis; no new physics.
...
Next: finish offline diagnosis and validated infrastructure repair; no replacement capture.
