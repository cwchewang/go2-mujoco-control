# Canonical clean-baseline repeatability — R3 of 3
...
Attempt starts at first valid post-handoff state/control sample. Pre-handoff execution failure is `PROTOCOL_FAILURE` with no scientific attempt consumed. Once handoff occurs, R3 is consumed; no retry.
