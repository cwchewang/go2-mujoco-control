# Praxis Task px_1a0bab35091_6ebd645e97
...
Validate Praxis Control Plane v0.1 approve-before-host semantics at the Go2 trusted-host boundary. This is infrastructure acceptance only.
...
- If a post-host closeout occurs, write only docs/validation/praxis_control_plane_v01_approval_20260920/RESULTS.md.
...
- docs/validation/praxis_control_plane_v01_approval_20260920/
...
```json
{
  ...
  "dogfood_kind": "approve-before-host"
}
```
...
```json
{
  ...
  "capability_request": {
    ...
    "domain_id": 217,
    "environment": {},
    "run_dir": "example/cpp/experiments/_runs/praxis_v01_approval_gate_20260920_r1",
    "schema_version": 1,
    "timeout_s": 300
  },
  "closeout_schema": [
  ...
  "mode": "infrastructure",
  "objective": "Validate Praxis Control Plane v0.1 approve-before-host semantics at the Go2 trusted-host boundary. This is infrastructure acceptance only.",
  "project": {
